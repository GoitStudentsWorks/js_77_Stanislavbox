      ...
      <ul class="books-list js-book-list">
              ${s.books.slice(0,e).map(({title:y,book_image:B,author:L,_id:S})=>`<li class="book-item"  data_id=${S}>
                      <div class ="img-wrapper">
                          <img class = "book-img" src="${B}" alt="Poster of ${y}" loading="lazy" />
